...
const uint8_t U8_MAX_EXTENSION = 10;
...
const int32_t I32_MATE = 25000;
	
const uint32_t U32_PAWN_HASH_TABLE_SIZE = 2048;
const uint32_t U32_EVAL_HASH_TABLE_SIZE = 16384;
