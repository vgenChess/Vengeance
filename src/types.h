...
enum Stage {
	PLAY_HASH_MOVE = 0, GEN_CAPTURES = 1, PLAY_CAPTURES = 2, PLAY_KILLER_MOVE_1 = 3,
	PLAY_KILLER_MOVE_2 = 4, PLAY_COUNTER_MOVE = 5, GEN_PROMOTIONS = 6,
	PLAY_PROMOTIONS = 7, PLAY_BAD_CAPTURES = 8, GEN_QUIETS = 9, PLAY_QUIETS = 10, STAGE_DONE = 100
};
